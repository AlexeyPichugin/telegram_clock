...
class Telegram_clock():
    ...
    def __enter__(self):
        ...
        print('Connection successfully create')
        return self
    ...
    def _create_time_image(self, tm):
        ...
        imsave(os.path(self.image_dir, 'time.png') ,reuslt)
        print('Image successfully create')
        return os.path(self.image_dir, 'time.png')


    def _update_avatar(self, image_path):
        print('Delete old photos')
        self.connection(DeletePhotosRequest(self.connection.get_profile_photos('me')))
        file = self.connection.upload_file(image_path)
        print('Create new photos')
